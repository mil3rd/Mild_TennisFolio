...
export default function AdminPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setStatusMsg("Saving achievement…");
      ...
      /* 3. Success */
      setStatus("success");
      setStatusMsg(`"${form.title}" saved! It will appear on the homepage.`);
      ...
      <main className="max-w-2xl mx-auto px-6 py-12">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <button
            ...
            className="w-full bg-sage text-cream font-lato font-semibold py-3 rounded-full text-base hover:bg-sage-dark transition-colors shadow-md disabled:opacity-50 disabled:cursor-not-allowed tracking-wide"
          >
